...
BOOL CALLBACK EnumWindowsProc(HWND hWnd, LPARAM lParam) {
	...
	lstrcat(childs, _T("Title: "));
	lstrcat(childs, caption);
	lstrcat(childs, _T(", Class: "));
	lstrcat(childs, classname);
	lstrcat(childs, _T("\n"));
	return TRUE;
}
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_KEYDOWN:
		...
		case VK_SPACE:
			...
			break;
		case VK_F1:
			hCalc = FindWindow(_T("CalcFrame"), NULL);
			EnumChildWindows(hCalc, EnumWindowsProc, (LPARAM)hWnd);
			RedrawWindow(hWnd, NULL, NULL, RDW_INVALIDATE | RDW_ERASENOW);
			break;
		}
	case WM_COMMAND:
	...
	case WM_PAINT:
		...
		RECT rect;
		SetRect(&rect, 0, 0, 500, 1000);
		DrawText(hdc, childs, _tcslen(childs), &rect, DT_LEFT);
		EndPaint(hWnd, &ps);
		break;
	case WM_DESTROY:
		PostQuitMessage(0);
