// Work_With_Resours.cpp: определяет точку входа для приложения.
//
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	switch (message)
	{
	//сообщение генерируемое при создании окна (инициализация)
	case WM_CREATE:
		//загрузка курсоров
	...
	//обработка сообщений от перемещения мыши
	case WM_MOUSEMOVE:
	{
