// Using_Timer.cpp: определяет точку входа для приложения.
//

#include "stdafx.h"
#include "Using_Timer.h"
//для работы с системным временем
#include <time.h>
...
//функция обратного вызова для обработки сообщений от таймера
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	static time_t t;//хранение времени
	static TCHAR str[100];//строка для вывода в заголовок
