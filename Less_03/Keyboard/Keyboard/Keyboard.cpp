// Keyboard.cpp: определяет точку входа для приложения.
//
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CHAR:
		...
		break;
	case WM_LBUTTONDOWN:	//при клике левом 
		MoveWindow(hWnd, 500, 200, 300, 300, true);	//окошко меняет размер
		break;
	case WM_RBUTTONDOWN:
		//получение информации об окне
		GetWindowRect(hWnd, &rect);
		wsprintf(str, TEXT("Параметры окна: x:%d, y:%d, ширина:%d, высота:%d"), rect.left, rect.top, rect.right - rect.left, rect.bottom - rect.top);
		MessageBox(hWnd, str, 0, MB_OK | MB_ICONINFORMATION);
		break;
	case WM_KEYDOWN:
		switch (wParam)
		{
